                            ...
                            <div class="form-group col-md-12">
                                ...
                                <ul style="list-style:none;padding-left:0">
                                    @foreach ($allCategories as $category)
                                        <li><label><input type="checkbox" name="category[]" value="{{ $category->id }}" {{ $categoriesForProduct->contains($category) ? 'checked="checked"' : '' }} style="margin-right:5px;" /> {{ $category->name }}</label></li>
                                    @endforeach
                                </ul>
                            </div>
